...
export default function PricingCard({
  ...
  return (
    <motion.div 
      ...
      className={`relative flex flex-col p-6 sm:p-8 rounded-2xl border ${isPopular ? 'border-blue-500 shadow-blue-500/10 dark:shadow-blue-900/20 shadow-xl shadow-[0_0_30px_rgba(37,99,235,0.15)]' : 'border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm'}`}
    >
      {isPopular && (
