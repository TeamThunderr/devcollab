...
export default function AuthPage(): React.ReactElement {
  ...
  const socialButtons = (
    <div className="flex space-x-4 justify-center my-4">
      <button type="button" className="w-10 h-10 rounded-full border border-gray-300 dark:border-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:border-gray-400 dark:hover:border-gray-500 transition-colors">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#0a0a0a] px-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-[850px] min-h-[550px] bg-white/70 dark:bg-gray-900/50 backdrop-blur-2xl rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] border border-gray-200/50 dark:border-gray-800/50 overflow-hidden flex z-10">
        ...
        <div
          className={`absolute top-0 left-0 h-full w-1/2 p-10 flex flex-col justify-center transition-all duration-700 ease-in-out ${
            isSignUp
        ...
        >
          {/* Overlay Background */}
          <div
            className={`bg-gradient-to-br from-[#2563eb] via-[#6366f1] to-[#a855f7] text-white relative -left-full h-full w-[200%] transform transition-transform duration-700 ease-in-out shadow-[inset_0_0_80px_rgba(0,0,0,0.2)] ${
              isSignUp ? "translate-x-1/2" : "translate-x-0"
            }`}
          >
            {/* Left Panel of Overlay */}
            <div
              className={`absolute top-0 w-1/2 h-full flex flex-col items-center justify-center px-10 text-center transition-transform duration-700 ease-in-out ${
