        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 pb-6 border-b border-white/[0.04]">
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <span className="px-3 py-1 text-[11px] font-bold uppercase tracking-widest bg-indigo-500/10 text-indigo-300 border border-indigo-500/20 rounded-md">
                Projects Hub
              </span>
              {subscription?.plan === 'PRO' ? (
                <span className="flex items-center gap-1.5 px-3 py-1 text-[11px] font-bold uppercase tracking-widest bg-amber-500/10 text-amber-300 border border-amber-500/20 rounded-md">
                  <Crown className="h-3.5 w-3.5" /> Pro Workspace
                </span>
              ) : (
                <span className="px-3 py-1 text-[11px] font-bold uppercase tracking-widest bg-slate-900 border border-slate-800 text-slate-400 rounded-md">
                  Free Account
                </span>
              )}
            </div>
            <h1 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
              <span className="text-gradient capitalize">{activeWorkspace?.name || 'Workspace'}</span> Projects
            </h1>
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 active:scale-[0.98] text-white px-5 py-2.5 text-sm font-bold transition-all shadow-md shadow-indigo-600/20 self-start md:self-center tracking-wide"
          >
                ...
                >
                  ...
                  <div className="space-y-3 pt-3 border-t border-white/[0.04] mt-4">
                    ...
                    <div className="space-y-1.5 text-left">
                      <div className="flex justify-between items-center text-[10px] text-slate-500 font-bold uppercase tracking-wider leading-none">
                        <span>Progress</span>
