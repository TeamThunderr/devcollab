 ...
 * Shows the team member table with role management — extracted
 * from WorkspaceDashboard so the dashboard can become a true activity feed.
 */
            ...
            <tbody>
              {members.map((member) => {
                ...
                return (
                  <tr
                    key={member.id}
                    className="bg-white border-b dark:bg-gray-900 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50"
                  >
                    ...
                    <td className="px-6 py-4">
                      {canManageMembers && !isOwner && !isMe ? (
                        <select
                          ...
                          className="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-800 dark:border-gray-700 dark:text-white disabled:opacity-50"
                        >
