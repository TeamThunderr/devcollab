...
function StatCard({ label, value, icon, accent }: StatCardProps) {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-slate-800 border border-slate-700 p-5 flex items-center gap-4">
...
function ProjectCard({
  ...
  return (
    <Link
      ...
      className="group flex flex-col gap-3 rounded-2xl bg-slate-800 border border-slate-700
    ...
    >
      ...
      <div className="flex items-center gap-4 mt-auto pt-1 border-t border-slate-700">
...
function ActivityItem({
  ...
  return (
    <div className="flex items-start gap-3 py-3 border-b border-slate-800 last:border-0">
      <div className="w-7 h-7 rounded-full bg-gradient-to-br from-slate-600 to-slate-700 flex items-center justify-center text-white text-[10px] font-bold flex-shrink-0 mt-0.5">
        {initials}
      </div>
    ...
    <div className="p-6 md:p-8 space-y-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl bg-slate-800 border border-slate-700 px-4 py-2 min-h-[200px]">
            {actLoading && activities.length === 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-10 text-center">
                <div className="w-9 h-9 rounded-full bg-slate-700 flex items-center justify-center mb-2">
                  <svg className="w-4 h-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <p className="text-xs font-medium text-slate-400">No activity yet</p>
                <p className="text-[11px] text-slate-600 mt-0.5">Events will appear here in real time.</p>
              </div>
            ) : (
              <div>
